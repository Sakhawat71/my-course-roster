...
const Cart = ({ price,courseNames,credit }) => {
    return (
        <div className="w-3/12 bg-white p-6 space-y-4">
            <h1 className='text-[#2F80ED] font-bold text-[18px]'>Credit Hour Remaining # hr</h1>
            <hr />
